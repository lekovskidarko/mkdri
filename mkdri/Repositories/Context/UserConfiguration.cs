...
namespace MKDRI.Repositories.Context
{
    public class UserConfiguration : IEntityTypeConfiguration<User>
    {
        ...
        public virtual void Configure(EntityTypeBuilder<User> builder)
        {
            ...
            builder.Property(x => x.FirstName).HasColumnName(@"FirstName").HasColumnType("character varying").HasMaxLength(50).IsRequired();
            builder.Property(x => x.LastName).HasColumnName(@"LastName").HasColumnType("character varying").HasMaxLength(50).IsRequired();
            builder.Property(x => x.Email).HasColumnName(@"Email").HasColumnType("character varying").HasMaxLength(250).IsRequired();
